...
class StockSpot(models.Model):
    ...
    change_percent = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True, verbose_name="涨幅")
    ...
    ytd_change_percent = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True, verbose_name="今年以来涨幅")
